...
#embed "actors/water_mine/water_mine_left_side_unused.rgba16.bin"
};

// 0x0600B4F8
ALIGNED8 static const Texture water_mine_seg6_texture_0600B4F8[] = {
#embed "actors/water_mine/water_mine_right_side_unused.rgba16.bin"
};

// 0x0600C4F8
ALIGNED8 static const Texture water_mine_seg6_texture_0600C4F8[] = {
#embed "actors/water_mine/water_mine_spike_unused.rgba16.bin"
};
